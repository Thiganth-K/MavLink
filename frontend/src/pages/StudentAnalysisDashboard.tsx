    ...
    <main className="flex-grow p-6 bg-gradient-to-br from-supercream to-green-200">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          <button onClick={() => { window.location.href = '/super-admin'; }} className="px-4 py-2 bg-white border border-supergreenDark/30 text-supergreenDark rounded-lg shadow hover:border-supergreenAccent transition-colors">◂ Dashboard</button>
        </div>
